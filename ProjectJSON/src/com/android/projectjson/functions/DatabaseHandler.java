...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	// Database Name
	private static final String DATABASE_NAME = "androjson";
	...
	//tabel sesi
	private static final String CREATE_SESI_TABLE = "CREATE TABLE " + TABEL_SESION+ "(" 
			+ KEY_ID + "INTEGER PRIMARY KEY," + KEY_SESI + " TEXT" + ")";
	
	//tabel sesi
	private static final String CREATE_LOGIN_TABLE = "CREATE TABLE " + TABEL_LOGIN + "("
			+ KEY_ID + "INTEGER PRIMARY KEY," + KEY_UID + " TEXT,"
			+ KEY_NAMA + " TEXT," + KEY_USERNAME + " TEXT," + KEY_PASSWRD
			+ " TEXT," + KEY_ALAMAT + " TEXT UNIQUE," + KEY_NOTLP
			+ " TEXT" + ")";
	...
	public void addUser(String nama, String username, String password,
			String uid, String alamat, String notlp) {
		SQLiteDatabase db = this.getWritableDatabase();

		ContentValues values = new ContentValues();
		values.put(KEY_UID, uid); // ID unik
		values.put(KEY_NAMA, nama); // Nama
		values.put(KEY_USERNAME, username); // Nama User
		values.put(KEY_PASSWRD, password); // Password User
		values.put(KEY_ALAMAT, alamat); // alamat
		values.put(KEY_NOTLP, notlp); // nomor telepon
